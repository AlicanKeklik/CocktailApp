...
data class CocktailDto(
    ...
    @SerializedName("strInstructionsZH-HANS"      ) var strInstructionsZHHANS      : String? = null,
    @SerializedName("strInstructionsZH-HANT"      ) var strInstructionsZHHANT      : String? = null,
...
fun CocktailDto.toCocktail(): Cocktail{
    return Cocktail(idDrink, strDrink, strDrinkThumb)
}

fun CocktailDto.toCocktailDetail():CocktailDetail{
    return CocktailDetail(strDrink,strDrinkThumb,strInstructions,strIngredient1,strIngredient2,strIngredient3,strIngredient4)
}